    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView bounces={false} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formArea}>
          ...
          <Field autoComplete="email" icon="envelope-o" inputLabel="Email address" keyboardType="email-address" label="Email Address" placeholder="you@example.com" textContentType="emailAddress" />
